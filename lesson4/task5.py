...
def josephus_task(num_people, kill_num):
    ...
    people_list = [x+1 for x in range(num_people)]
    index_dlya_udaleniya = 0
    while len(people_list) > 1:
        index_dlya_udaleniya = index_dlya_udaleniya + kill_num - 1
        while index_dlya_udaleniya > len(people_list) - 1:
            index_dlya_udaleniya = index_dlya_udaleniya - len(people_list)
        people_list.pop(index_dlya_udaleniya)
